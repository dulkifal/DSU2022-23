  ...
  return (
    <div className="mx-auto">
      ...
      <div className="card m-3 ">
        ...
        <div className="card-body d-flex flex-row justify-content-around">
          <div>
            ...
            <button   className="btn btn-block btn-primary" disabled={one}
            onClick={()=>{
      ...
      <div className="card m-3">
        ...
        <div className="card-body d-flex flex-row justify-content-around">
          <div>
            ...
            />
            <h5 className="card-title">Card title</h5>
            <button className="btn btn-block btn-primary" disabled={two}
            onClick={()=>{
      ...
      <div className="card m-3 ">
        ...
        <div className="card-body d-flex flex-row justify-content-around">
          <div>
            ...
            />
            <h5 className="card-title">Card title</h5>
            <button className="btn btn-block btn-primary" disabled={three}
            onClick={()=>{
      ...
      <div className="row pt-5">
        <a href="#" className="btn p-3 col  align-self-center btn-primary">
          Logout Out
        </a>
      </div>
    </div>
